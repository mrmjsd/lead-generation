...
class VendorDetails(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    vendor_name = Column(String(length=255), nullable=False)
    vendor_contact = Column(String(length=255), nullable=False)

class FinancialReporting(Base):
    __tablename__ = "financial_reporting"
    id = Column(Integer, primary_key=True, index=True)
    report_period = Column(String(length=255), nullable=False)
...
class AuditTrail(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    approver = Column(String(length=255), nullable=False)  
    preparer = Column(String(length=255), nullable=False)  # New field added
...
class Voucher(Base):
    ...
    voucher_no = Column(String(length=255), nullable=False)
    prepared_by = Column(String(length=255), nullable=False)
    approved_by = Column(String(length=255), nullable=False)
    authorized_by = Column(String(length=255), nullable=False)
    receiver_signature = Column(String(length=255), nullable=False)
    employee_id = Column(Integer, ForeignKey("employees.id"))
    payment_id = Column(Integer, ForeignKey("payments.id"))
    total_amount = Column(Float, nullable=False)
    in_words = Column(String(length=255), nullable=False)
    expense_category = Column(String(length=255), nullable=False)
    payment_status = Column(String(length=255), nullable=False)
    payment_dues = Column(Float, nullable=False)
    cash_flow_impact = Column(String(length=255), nullable=False)
